...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Jan 2022 pada 14.52
...
(5, '309', 981818, '<p>Kamar dirancang demi kenyamanan anda selama menginap . Dilengkapi fasilitas seperti AC, TV dan lain-lain. </p><p>Fasilitas Kamar : </p> AC , TV, Minibar, Brankas, Tempat tidur yang nyaman, Kamar mandi, Akses internet', 1, 1),
...
(9, 'SarjanaKomedi', '0851928391', 'Jl. Hello World', '2020-01-01', '2020-01-02', 5, 1);
...
(4, 'rian', 'rian@gmail.com', 0, 'admin', '21232f297a57a5a743894a0e4a801fc3', 1);
